// Try running with:
//  - compute-sanitizer's various tools
//  - cuda-gdb
//      - set a break point inside the kernel
//      - inspect local variables
//      - note: remember to set "-G" compiler flag!
//
// Which bugs is compute-sanitizer able to find? 
// Which bugs is compute-sanitizer not able to find?
// How does the runtime change with/without compute-sanitizer?
// How does the runtime change with/without "-G"?
