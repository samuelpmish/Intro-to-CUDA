...
MULTI_TARGETS := poisson_0 poisson_1 poisson_2 poisson_3 poisson_4 poisson_4_cusparse poisson_5 \
                 laplace_tuning laplace_tuning_sweep
...
$(eval $(call MULTI_SOURCE_CUDA_EXECUTABLE,poisson_4_cusparse,06_profiling/poisson_4/vector.cu 06_profiling/poisson_4/poisson_cusparse.cu))
$(eval $(call MULTI_SOURCE_CUDA_EXECUTABLE,poisson_5,06_profiling/poisson_5/vector.cu 06_profiling/poisson_5/poisson.cu))
$(eval $(call MULTI_SOURCE_CUDA_EXECUTABLE,laplace_tuning,06_profiling/poisson_5/laplace_tuning.cu))
$(eval $(call MULTI_SOURCE_CUDA_EXECUTABLE,laplace_tuning_sweep,06_profiling/poisson_5/laplace_tuning_sweep.cu))

$(BUILD_DIR)/poisson_4 $(BUILD_DIR)/poisson_4_cusparse: LDLIBS += -lcusparse
